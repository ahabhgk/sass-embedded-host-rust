...
pub mod value {
  ...
  pub struct ArgumentList {
    ...
    pub keywords:
      ::std::collections::HashMap<::prost::alloc::string::String, super::Value>,
  }
  ...
  pub mod calculation {
    ...
    pub struct CalculationOperation {
      ...
      pub left:
        ::core::option::Option<::prost::alloc::boxed::Box<CalculationValue>>,
...
impl LogEventType {
  ...
  pub fn as_str_name(&self) -> &'static str {
    match self {
      ...
      LogEventType::DeprecationWarning => "DEPRECATION_WARNING",
...
impl ProtocolErrorType {
  ...
  pub fn as_str_name(&self) -> &'static str {
    match self {
      ProtocolErrorType::Parse => "PARSE",
      ProtocolErrorType::Params => "PARAMS",
...
impl SingletonValue {
  ...
  pub fn as_str_name(&self) -> &'static str {
    match self {
      SingletonValue::True => "TRUE",
      SingletonValue::False => "FALSE",
      SingletonValue::Null => "NULL",
    }
  }
  /// Creates an enum from field names used in the ProtoBuf definition.
  pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
...
impl CalculationOperator {
  ...
  pub fn as_str_name(&self) -> &'static str {
    match self {
      ...
      CalculationOperator::Divide => "DIVIDE",
    }
  }
  /// Creates an enum from field names used in the ProtoBuf definition.
  pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
